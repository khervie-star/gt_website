      ...
      <div className="container mx-auto px-4 py-16">
              ...
              <div className="p-8 lg:p-12 flex flex-col justify-center bg-gradient-to-br from-primary to-purple-900 text-white">
                <div className="space-y-6">
                  ...
                  <p className="text-xl text-purple-100 leading-relaxed">
                    Download our mobile app to listen to powerful sermons, follow along with scripture, 
                    and grow spiritually wherever you are. Never miss a message again.
                  </p>
                  ...
                  <div className="space-y-4 pt-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-lg">Interactive Scripture Reading</span>
                    </div>
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <span className="text-lg">Personal Notes & Bookmarks</span>
                    </div>
                      ...
                      <div className="w-full h-full bg-card rounded-[2.5rem] relative overflow-hidden border border-border">
                        ...
                        <div className="absolute inset-0 bg-gradient-to-b from-primary via-primary to-purple-900">
                          ...
                          <div className="px-8 py-6">
                            <h3 className="text-white text-3xl font-bold">Sermons</h3>
                            <p className="text-purple-100 text-base mt-1">Latest Messages</p>
                          </div>
                          ...
                          <div className="px-8 mb-6">
                            <div className="bg-white/10 backdrop-blur-md rounded-2xl px-4 py-3 border border-white/20">
                              <div className="flex items-center space-x-3">
                                ...
                                <span className="text-white/70 text-sm">Search sermons...</span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="px-8 space-y-4 flex-1">
                            ...
                            <div className="bg-white/15 backdrop-blur-md rounded-3xl p-5 border border-white/20">
                              <div className="flex items-center space-x-4">
                                ...
                                <div className="flex-1">
                                  <h4 className="text-white font-bold text-base">Walking in Faith</h4>
                                  <p className="text-purple-100 text-sm">Pastor John Smith</p>
                                  <div className="flex items-center mt-2 space-x-2">
                                    <div className="flex-1 h-1 bg-white/20 rounded-full">
                                      <div className="w-1/3 h-full bg-amber-300 rounded-full"></div>
                                    </div>
                                    <span className="text-xs text-purple-100">15:32</span>
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                              <div className="flex items-center space-x-3">
                                ...
                                <div className="flex-1">
                                  <h4 className="text-white font-semibold text-sm">God's Amazing Grace</h4>
                                  <p className="text-purple-100 text-xs">Pastor Sarah Johnson • 38 min</p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-4 border border-white/10">
                              <div className="flex items-center space-x-3">
                                ...
                                <div className="flex-1">
                                  <h4 className="text-white font-semibold text-sm">Love & Hope in Christ</h4>
                                  <p className="text-purple-100 text-xs">Pastor Mike Davis • 42 min</p>
                                </div>
                              </div>
                            </div>
                          </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <div className="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">High Quality Audio</h3>
            <p className="text-gray-600">Crystal clear audio quality for an immersive listening experience.</p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Download & Save</h3>
            <p className="text-gray-600">Save sermons for offline listening when you're on the go.</p>
          </div>
          ...
          <div className="text-center p-6 bg-white rounded-2xl shadow-lg hover:shadow-xl transition-shadow duration-300">
            ...
            <h3 className="text-xl font-bold text-gray-800 mb-2">Easy Navigation</h3>
            <p className="text-gray-600">Find and organize your favorite sermons with intuitive controls.</p>
          </div>
        </div>
      </div>
    </div>
